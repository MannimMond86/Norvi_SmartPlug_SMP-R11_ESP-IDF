...
void display_BootMenu1(void){
        ssd1306_clear_screen(&dev, false);
        char system_start_str[12];
        int value = system_starts;
        snprintf(system_start_str, sizeof(system_start_str), "%06d", value);

        ssd1306_display_text_box1(&dev, 0, 0, "Version", 4, 4, false, 100);
    	ssd1306_display_text_box1(&dev, 0, 40, "01.02.03", 8, 8, false, 100);

        ssd1306_display_text_box1(&dev, 1, 0, "Start: ", 7, 7, false, 100);
        ssd1306_display_text_box1(&dev, 1, 50, system_start_str, 6, 6, false, 100);
